...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      secondary: "bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-500 disabled:bg-gray-200/50 dark:bg-dark-700 dark:text-gray-200 dark:hover:bg-dark-600 dark:disabled:bg-dark-700/50",
