/**
 * Environment services for server-side use
 *
 * This file contains services for interacting with the environments API from the server.
 */

import { apiGet, apiPost, apiPatch, apiDelete } from "~/core/services/api-client.server";
